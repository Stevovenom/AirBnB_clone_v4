$(document).ready(function () {
    ...
    // Handle changes in Amenities checkboxes
    ...
    // Handle changes in States checkboxes
    $('.locations .popover h2 input[type=checkbox]').click(function () {
        ...
        if (myListName.length === 0) {
            ...
            $('.locations h4').text(myListName.join(', '));
        }
        console.log(myStates);
    });

    // Handle changes in Cities checkboxes
            ...
            $.get('/reviews', function (data) {
                ...
                data.forEach(review => {
                    reviewsHtml += `<div class="review">
                        <h4>${review.title}</h4>
                        <p>${review.text}</p>
                        <p><strong>${review.user_id}</strong> - ${review.date}</p>
                    </div>`;
                });
